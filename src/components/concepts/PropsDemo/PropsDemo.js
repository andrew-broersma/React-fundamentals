...
//                 <FunctionalComponent string="Props are pretty cool, right?" function={toggleColor} selectedStyle={ color } />
//                 <FunctionalComponent string="You can send data from one component..." function={toggleBorderRadius} selectedStyle={ borderRadius } />
//                 <FunctionalComponent string="... to another!" function={toggleBackgroundColor} selectedStyle={ backgroundColor } />
//                 </div>
//             </div>
//         </div>
//     )
